...
\begin{multicols}{4}
\begin{center}
    \adjincludegraphics[width=.975\linewidth,clip,trim=616px 426px 416px 251px]{bet1}
    Formato incorrecto
\end{center}
\columnbreak
\begin{center}
    \adjincludegraphics[width=.975\linewidth,clip,trim=616px 426px 416px 251px]{bet2}
    Apuesta muy pequeña
\end{center}
\columnbreak
\begin{center}
    \adjincludegraphics[width=.975\linewidth,clip,trim=616px 426px 416px 251px]{bet3}
    Apuesta muy grande
\end{center}
\columnbreak
\begin{center}
    \adjincludegraphics[width=.975\linewidth,clip,trim=616px 426px 416px 251px]{bet4}
